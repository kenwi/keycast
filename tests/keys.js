...
assert(mouseDefaults.mouseRippleFollowMs === 16, "follow rate default")
assert(Keys.normalizeSettings({ mouseRippleFollowMs: 4 }).mouseRippleFollowMs === 8, "follow rate min")
assert(Keys.normalizeSettings({ mouseRippleFollowMs: 90 }).mouseRippleFollowMs === 64, "follow rate max")
