...
assert(Keys.comboToLabels("SUPER+LEFT").join(",") === "Super,Left", "labels super left")
assert(Keys.comboToLabels("SUPER+SHIFT+LEFT").join(",") === "Super,Shift,Left", "labels super shift left")
