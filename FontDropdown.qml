...
// Searchable font picker. Same shape as qs.Ui SearchableDropdown, with a
// visible scrollbar on the result list so a long system font catalog is
// easier to scan.
//
            ...
            ListView {
              ...
              QQC.ScrollBar.vertical: QQC.ScrollBar {
                ...
                contentItem: Rectangle {
                  implicitWidth: Style.space(10)
                  radius: width / 2
                  visible: fontScroll.size < 1.0
                  color: Util.alpha(root.foreground, fontScroll.pressed ? 0.55 : (fontScroll.hovered ? 0.40 : 0.28))
                }
              }
